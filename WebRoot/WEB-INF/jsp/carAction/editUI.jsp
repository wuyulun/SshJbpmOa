...
<div id="add-cheliang-panel">
    ...
    <s:form action="Car_editCar?id=%{id}">
        <div style="float:left;width:700px;margin-left:16px;margin-bottom:50px;">
            <lable>品牌：</lable>
            <s:textfield name="brand" cssClass="easyui-textbox"/>
        </div>
        <div style="float:left;width:700px;margin-left:16px;margin-bottom:50px;">
            <lable>座位：</lable>
            <s:textfield name="seat" cssClass="easyui-textbox"/>
        </div>
        <div style="float:left;width:700px;margin-bottom:50px;">
            <lable>车牌号：</lable>
            <s:textfield name="number" cssClass="easyui-textbox"/>
        </div>
