...
<body>
<table id="table-daibanshenqing-geren">
    <tbody>
    <s:iterator value="goodsTaskViewslist">
        <tr>
            <td>${goodsform.applytime}&nbsp;</td><td>${goodsform.gapplicant.name}&nbsp;</td><td>${goodsform.department}&nbsp;</td><td>${goodsform.muchGoods}&nbsp;</td><td>${goodsform.donetime}&nbsp;</td><td><a href="wupinshenpi_approveUI.do?taskId=${task.id}&goodsformId=${goodsform.id}">${goodsform.status}</a></td>
        </tr>
        </s:iterator>
    </tbody>    
</table>
