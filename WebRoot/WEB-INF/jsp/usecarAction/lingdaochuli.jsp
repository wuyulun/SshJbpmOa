...
<body>
<table id="table-yongchedaiban-lingdao">

    <tbody>
    <s:iterator value="usecarformTaskViewslist">
        <tr>
            <td>${usecarform.applytime}&nbsp;</td><td>${usecarform.uapplicant.name}&nbsp;</td><td>${usecarform.ucdepartment}&nbsp;</td><td>${usecarform.place}&nbsp;</td><td>${usecarform.people}&nbsp;</td><td>${usecarform.stuff}&nbsp;</td><td>${usecarform.usecartime}&nbsp;</td><td>${usecarform.status}&nbsp;</td><td><a href="usecar_shouli.do?taskId=${task.id}&usecarformId=${usecarform.id}">同意</a></td>
