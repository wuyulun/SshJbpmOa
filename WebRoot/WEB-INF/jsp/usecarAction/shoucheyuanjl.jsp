...
<table id="table-yongcheshenpi-lingdao">
    ...
    <s:iterator value="usecarformsList">
        <tr>
         <td>${uapplicant.name}</td><td>${applytime}</td><td>${ucdepartment}</td><td>${place}</td><td>${people}</td><td>${stuff}</td><td>${usecartime}</td><td>${carmessage}</td><td>${cartime}</td><td>${status}</td>
