...
<body>
<table id="table-yongchejilu">

    <tbody>
    <s:iterator value="usecarformsList">
        <tr>
              <td>${uapplicant.name}</td><td>${applytime}</td><td>${place}</td><td>${people}</td><td>${stuff}</td><td>${usecartime}</td><td>${carmessage}</td><td>${leadertime}</td><td>${status}</td>
