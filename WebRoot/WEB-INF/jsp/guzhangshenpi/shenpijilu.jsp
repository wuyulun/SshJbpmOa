...
<body>
<table id="table-shenbaojilu">
    <tbody datakey="formList">
    <s:iterator value="faultformsList">
        <tr>
           <td>${department}&nbsp;</td><td>${applicant.name }&nbsp;</td><td>${applytime }&nbsp;</td><td>${description}&nbsp;</td><td>${donetime}</td><td>叶冠林</td><td>${status}&nbsp;</td>
        </tr>
        </s:iterator>	
         </tbody>
</table>
