...
<head>
    ...
    function showProcessImage( pdId ){
        ...
        window.showModalDialog(url, null, "dialogHeight:400px, dialogWidth:600px;resizable:yes");//弹出小窗口
    }
    ...
    <table cellspacing="0" cellpadding="0" class="TableStyle">
        ...
        <s:iterator value="pdList">
			<tr class="TableDetail1 template">
					...
					<td>${description}&nbsp;</td>
					<td>
					<s:a action="processDefinition_delete?key=%{key}" onClick="return delConfirm()">
						<%-- 该字段用于utf8自动编码<s:param name="key" value="%{key}"></s:param> --%>删除
					</s:a>
