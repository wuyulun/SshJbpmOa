...
<div id=MainArea>
    ...
    <s:form action="processDefinition_add" enctype="multipart/form-data"><!-- struts2上传文件 -->
        ...
        <div class="ItemBlockBorder">
            <div class="ItemBlock">
                <table cellpadding="0" cellspacing="0" class="mainForm">
                    <tr>
						<td>请选择流程定义文档(zip格式)</td><!--以下class为表格提示  -->
                        <td><input type="file" name="upload" class="InputStyle {accept:'zip'} required" style="width:450px;" /> *</td><!-- 此字段的类型不能回显 -->
                    </tr>
                </table>
            </div>
        </div>
