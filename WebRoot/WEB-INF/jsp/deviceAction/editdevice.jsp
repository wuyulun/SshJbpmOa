...
<div id="add-shebei-panel">
    ...
    <s:form action="Device_editDevice">
    <s:hidden name="id"></s:hidden>
        ...
        <div style="float:left;width:700px;margin-bottom:50px;margin-left:32px;">
            <lable>品牌：</lable>
        ...
        <div style="float:left;width:700px;margin-bottom:30px;margin-left:32px;">
            <lable>参数：</lable>
        ...
        <div style="float:left;width:700px;margin-bottom:50px;margin-left:17px;">
            <lable>负责人：</lable>
        ...
        <%-- <div style="float:left;margin-bottom:50px;">
            ...
            <s:textfield name="buytime" cssClass="easyui-textbox"/>
        </div> --%>
