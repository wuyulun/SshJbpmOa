...
<body>
<div id="add-bumen-panel">
	<div class="add-bumen-textbox">
     <s:form action="department_%{id == null ? 'add' : 'edit'}">
       <s:hidden name="id"></s:hidden>
        <div style="float:left;width:700px;margin-bottom:30px;margin-right:120px">
            <lable>上级部门：</lable>
            <s:select name="parentId" cssClass="easyui-combobox" data-options="editable:false" style="width:200px;height:32px;"
        ...
        <div style="float:left;margin-bottom:30px;">
            <lable>职能说明：</lable>
             <td><s:textarea name="description" cssClass="easyui-textbox" data-options="multiline:true" style="width:500px;height:120px"></s:textarea></td>
        </div>
