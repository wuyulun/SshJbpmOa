...
<div style="float:left;width:40%;margin:20px;">
    <div id="woyaodingcan-wancan" ${pageContext.request.contextPath}/ht/style="height:200px;">
        ...
        <span style="display:block;font-size:18px;color:#68B1FA;font-weight:bold;">已报名</span>
        </div>
    </div>
</div>
</body>
