...
import com.hyjcy.oa.domain.ApproveInfo;
 ...
 * @Author：Ysy
 * @Date:2016年8月24日10:56:06
 * @version:1.0
 * @Description:流转功能Action
 */
...
public class FlowAction extends BaseAction{
	...
	public String submit() throws Exception {
		...
		System.out.println("_-------______"+application.getTemplate()+application.getPath()+application.getApplicant());
	...
	public String myApplicationList() throws Exception {
		...
		new QueryHelper(Application.class, "a")//
				...
				.addWhereCondition((templateId != null), "a.template.id=?",
						templateId)// 判断模板是否有效
				.addWhereCondition(
						(status != null && status.trim().length() > 0),
						"a.status=?", status)// 判断状态是否有效
				.addOrderByProperty("a.applyTime", false)// 按降序排序
	...
	public String myTaskList() throws Exception {
		...
		List<TaskView> taskViewList = flowService
	...
	public String approve() throws Exception {
		...
		approveInfo.setApplication(flowService
				.getApplicationById(applicationId)); // 所属的申请
	...
	public String approvedHistory() throws Exception {
		List<ApproveInfo> approveInfoList = flowService
				.getApproveInfosByApplicationId(applicationId);
